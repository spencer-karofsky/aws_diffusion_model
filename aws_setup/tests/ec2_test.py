...
"""
import boto3
from aws_setup.managers.ec2_manager import EC2InstancesManager, EC2KeyPairManager, EC2SecurityManager, EC2VolumeManager
...
class EC2KeyPairManagerTest(unittest.TestCase):
    def setUp(self):
        ...
        self.client = boto3.client('ec2')
        self.instances_manager = EC2InstancesManager(self.client)
        self.key_pair_manager = EC2KeyPairManager()
...
class EC2SecurityManagerTest(unittest.TestCase):
    def setUp(self):
        """Set up mocked EC2 Security Manager
        """
        # Mock EC2
        self.mock = mock_ec2()
        self.mock.start()
